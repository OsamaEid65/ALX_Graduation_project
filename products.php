...
<html>
    <head>
        <link rel="shortcut icon" href="https://www.logolynx.com/images/logolynx/da/da0b82424b8a41df8230a34e6016b186.png" />
        <title>Osama Eid Store</title>
        <meta charset="UTF-8">
    ...
    <body>
        <div>
            ...
            <div class="container">
                <div class="jumbotron">
                    <h1>Welcome to Osama Eid  Store!</h1>
           ...
           <footer class="footer">
               <div class="container">
                <center>
                   <p>Copyright &copy Osama Eid  Store. All Rights Reserved.</p>
               </center>
               </div>
           </footer>
        </div>
